//Question : 
// Element.innerHTML is used to populate a div with HTML . Search online about this method and create a website with a div tag combining a random joke given an array of jokes . Use Math.random and fetch jokes from the internet(use any website to create the array) . Your website should show a random jokes on every reload . Minimum length of your array should be 10 .
...
let randomNumber = random(0 , dadJokes.length - 1) ;

let container = document.getElementById("container") ;

container.innerHTML = `<p>${dadJokes[randomNumber].question} <br> ${dadJokes[randomNumber].answer} </p>` ;



// document.body.firstChild.value
// undefined
